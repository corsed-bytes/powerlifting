...
let InternMenuComponent = class InternMenuComponent {
    ...
    constructor(inter) {
        this.inter = inter;
        this.apps$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])([{ link: '/intern/organization', name: 'Powerlifting-Organizer' }]);
        this.systemApps$ = Object(rxjs__WEBPACK_IMPORTED_MODULE_3__["of"])([
            { link: '/intern/system', name: 'Monitoring' },
            { link: '/intern/tracker', name: 'Tracker' }
        ]);
    }
    ngOnInit() { }
};
...
let DetailComponent = class DetailComponent {
    constructor(system, http, data) {
        ...
        this.apis$ = this.http.get(`${this.system.originByModule(this.data.module)}/api/latest`);
    }
    ngOnInit() { }
};
